...
icon = Image.open(r"C:\Users\swapnil\Downloads\airbnb..png")
st.set_page_config(page_title= "Airbnb Data Visualization | By Arbaz Shaikh",
                   page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={"About": """# This dashboard app is created by *Arbaz Shaikh*!
...
with st.sidebar:
    selected = option_menu("Menu", ["Home","Overview","Explore","About"], 
                           ...
                           styles={"nav-link": {"font-size": "20px", "text-align": "left", "margin": "-2px", "--hover-color": "#FF5A5F"},
                                   "nav-link-selected": {"background-color": "#FF585D"}}
                          )



# CREATING CONNECTION WITH MONGODB ATLAS AND RETRIEVING THE DATA
client = pymongo.MongoClient("mongodb+srv://arbajhasanshaikh1998:arbazshbk@cluster0.lkcgjzj.mongodb.net/?retryWrites=true&w=majority")
...
# HOME PAGE
if selected == "Home":
    st.header( ":red[Airbnb Analysis]" , divider= 'red')
...
if selected == "About":
    ...
    with col1:
        st.write(" ")
        st.write(" ")
        st.markdown("### :violet[About Airbnb:] ")
        ...
        st.write("https://github.com/Arbazshbk/Airbnb_Analysis-")
